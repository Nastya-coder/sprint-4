...
class TestPageScooterHome:
    ...
    def test_faq(self, page_home, faq_section):
        page_home.open()
    ...
    def test_order_button_top(self, page_home):
        page_home.open()
        page_home.click_button_order_top()
        page_order = PageScooterOrder(page_home.driver)
    ...
    def test_order_button_bottom(self, page_home):
        page_home.open()
    ...
    def test_yandex_button(self, page_home):
        page_home.open()
