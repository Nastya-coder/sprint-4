...
class TestPageScooterOrder:     
    ...
    def test_your_info(self, driver, first_name, last_name, address, station, number):
    ...
    def test_rent_info(self, driver, date, duration, is_black, is_gray, comment):
        page_order = PageScooterOrder(driver)
        page_order.open()
    ...
    def test_order_confirmation(self, driver, user_info, rent_info):
        page_order = PageScooterOrder(driver)
        page_order.open()
